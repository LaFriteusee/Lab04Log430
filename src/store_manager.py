...
# Auto-generate Redis reports 2 seconds after startup (to give enough time for the DB to start up as well).
# Once done for the first time, repeat it recursively every 60s to refresh the cache.
